...
<li style="list-style-type:none">Jeong, H., Saakes, D.P., Lee, U., <a href="http://ubicomp.org/ubicomp2015/">I-Eng: An Interactive Toy for Second Language Learning</a> <i>Ubicomp/ISWC 2015 Demos</i> Accepted.</li>
...
<li style="list-style-type:none">Saakes, D.P. <a href="http://opendesignnow.org/">Opportunities for the new designers, challenges for the old designers.</a> In Van Abel, B., et.al. ed. <i>오픈 디자인(Open Design Now) 누구도 독점하지 않는 디자인 누구나 할 수 있는 디자인</i>, Ahn Graphics, Seoul, 2015.</li>
<li style="list-style-type:none">Verlinden, J., Saakes, D.P., Luxen, R. <a href="http://acoms.jams.or.kr/journal.do?method=journalintro&journalSeq=J000006">Learning from the trenches of embodiment design
